angular.module('finding', ['ngResource']).factory('Finding', ['$resource', function($resource)
{
    var Finding = $resource('http://svcs.ebay.com/services/search/FindingService/v1',
    {
...
function FindingCtrl($scope, $rootScope, $location, Finding, Storage)
{
    $scope.user = Storage;
    $scope.change = true;
    $scope.sortOrders = 
